custom_imports = dict(
    imports=[
        ...
        'mmaction.datasets.transforms.LoadTrackInfo',
        'mmaction.models.roi_heads.track_modules',
        'mmaction.models.roi_heads.scm_fusion',
        'mmaction.models.roi_heads.roi_head',
...
# —— 在这里添加 early-stop hook ——  
#default_hooks = dict(
#    stop=dict(
#        type='StopByMetricHook',
#        metric='mAP/overall',
#        rule='greater',
#        patience=60
#    )
...
train_pipeline = [
    ...
    #dict(type='PrintFirstSample'),
    dict(type='RawFrameDecode', **file_client_args),                 #mmaction/datasets/transforms/loading.py
    
    ###自己增加的轨迹模块###
    dict(type='LoadTrackInfo', track_base_path='/home/caojs/mmaction2/data03/ava/trackID'),
    ...
    dict(type='PackActionInputs',algorithm_keys=['track_vector']) #将处理好的数据打包成适合模型输入的格式
]
